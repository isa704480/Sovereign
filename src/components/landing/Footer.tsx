    ...
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-5 py-12 md:flex-row md:items-start md:justify-between md:px-8">
        ...
        <div className="grid grid-cols-2 gap-10 text-sm sm:grid-cols-3">
          <div>
            <div className="mb-3 text-xs font-medium uppercase tracking-wider text-text-muted">Mahsulot</div>
            <ul className="space-y-2 text-text-secondary">
              <li><a href="#features" className="hover:text-text-primary">Imkoniyatlar</a></li>
              <li><a href="#models" className="hover:text-text-primary">Modellar</a></li>
              <li><a href="#privacy" className="hover:text-text-primary">Maxfiylik</a></li>
            </ul>
          </div>
          <div>
            <div className="mb-3 text-xs font-medium uppercase tracking-wider text-text-muted">Hisob</div>
            <ul className="space-y-2 text-text-secondary">
              <li><Link href="/login" className="hover:text-text-primary">Kirish</Link></li>
              <li><Link href="/register" className="hover:text-text-primary">Ro&apos;yxatdan o&apos;tish</Link></li>
            </ul>
          </div>
          <div>
      ...
      <div className="border-t border-border/60">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-5 py-5 text-xs text-text-muted md:flex-row md:items-center md:justify-between md:px-8">
          <span>© 2026 FayzInc. Barcha huquqlar himoyalangan.</span>

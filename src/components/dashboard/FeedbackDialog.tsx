      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="tt relative w-full max-w-lg rounded-[22px] border p-6"
            style={{
            ...
            {state === "sent" ? (
              ...
              <>
                ...
                <textarea
                  ...
                  aria-invalid={!!error}
                  className="mt-3 w-full resize-none rounded-xl border bg-transparent px-3.5 py-3 text-sm outline-none focus:border-[var(--t-primary)]"

...
export const LANDING = {
  ...
  ldFeat3Body: {
    uz: "Har javob faktlar bazasi va internet manbalariga solishtiriladi. Xato belgilanadi, to'g'ri tasdiqlanadi.",
    "uz-cyrl": "Ҳар жавоб фактлар базаси ва интернет манбаларига солиштирилади. Хато белгиланади, тўғри тасдиқланади.",
    ru: "Каждый ответ сверяется с базой фактов и интернет-источниками. Ошибки помечаются, верное подтверждается.",
    en: "Every answer is checked against a fact base and web sources. Mistakes get flagged, correct facts get confirmed.",
  },

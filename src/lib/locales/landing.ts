...
export const LANDING = {
  ...
  ldFeat2Body: {
    uz: "AI sizni yillar davomida o'rganadi. Xotirani istalgan payt ko'rasiz, eksport qilasiz yoki o'chirasiz.",
    "uz-cyrl": "AI сизни йиллар давомида ўрганади. Хотирани исталган пайт кўрасиз, экспорт қиласиз ёки ўчирасиз.",
    ru: "ИИ узнаёт вас годами. Память всегда можно посмотреть, экспортировать или удалить.",
    en: "AI gets to know you over the years. You can view, export or delete that memory at any time.",
  },
  ...
  ldFeat6Title: {
    uz: "Ma'lumotlaringiz nazoratingizda",
    "uz-cyrl": "Маълумотларингиз назоратингизда",
    ru: "Ваши данные под вашим контролем",
    en: "Your data, your control",
  },
  ldFeat6Body: {
    uz: "Blind Prompting shaxsiy ma'lumotlarni so'rov ketishidan oldin niqoblaydi. Suhbatlar hisobingizga bog'langan, diskda shifrlangan va bir tugma bilan o'chiriladi.",
    "uz-cyrl": "Blind Prompting шахсий маълумотларни сўров кетишидан олдин ниқоблайди. Суҳбатлар ҳисобингизга боғланган, дискда шифрланган ва бир тугма билан ўчирилади.",
    ru: "Blind Prompting маскирует личные данные до отправки запроса. Чаты привязаны к вашему аккаунту, зашифрованы на диске и удаляются одной кнопкой.",
    en: "Blind Prompting masks personal data before a request is sent. Chats are tied to your account, encrypted at rest and deleted with one click.",
  },
  ...
  ldPrivacyTitle2: { uz: "Blind Prompting bilan — sizni emas.", "uz-cyrl": "Blind Prompting билан — сизни эмас.", ru: "С Blind Prompting — не вас.", en: "With Blind Prompting — not you." },
  ldPrivacyBody: {
